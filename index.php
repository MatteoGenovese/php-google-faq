...
<body>
    ...
    $faqs = [
        ...
        [
            ...
            <a href='#'> contattare il webmaster </a>
        ...
        [
            ...
            "answer" => "
            <p>In alcuni casi sì. Quando fai clic su un risultato della Ricerca Google, il tuo browser web potrebbe reindirizzare alla pagina web di destinazione anche l'indirizzo Internet, o URL, della pagina dei risultati di ricerca sotto forma di 
            <a href='#'> URL referrer </a>
    ...
    <header>
        <div class="up-menu">
            ...
            <div class="account-container">
                <div class="menu-expander"><i class="fa-regular fa-grip-dots"></i></div>
                <div class="account-settings">m</div>
